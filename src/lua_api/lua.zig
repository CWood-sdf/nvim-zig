...
pub const REGISTRYINDEX = -@as(c_int, 10000);
pub const ENVIRONINDEX = -@as(c_int, 10001);

pub const CFunction = *allowzero const fn (L: *State) callconv(.C) c_int;

pub const Number = f64;

extern fn lua_pushcclosure(L: *State, fun: CFunction, n: c_int) void;
pub const push_cclosure = lua_pushcclosure;
