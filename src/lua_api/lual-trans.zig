...
pub extern fn luaL_openlib(L: ?*lua_State, libname: [*c]const u8, l: [*c]const luaL_Reg, nup: c_int) void;
pub extern fn luaL_register(L: ?*lua_State, libname: [*c]const u8, l: [*c]const luaL_Reg) void;
...
pub extern fn luaL_typerror(L: ?*lua_State, narg: c_int, tname: [*c]const u8) c_int;
pub extern fn luaL_argerror(L: ?*lua_State, numarg: c_int, extramsg: [*c]const u8) c_int;
pub extern fn luaL_checklstring(L: ?*lua_State, numArg: c_int, l: [*c]usize) [*c]const u8;
pub extern fn luaL_optlstring(L: ?*lua_State, numArg: c_int, def: [*c]const u8, l: [*c]usize) [*c]const u8;
...
pub extern fn luaL_checkoption(L: ?*lua_State, narg: c_int, def: [*c]const u8, lst: [*c]const [*c]const u8) c_int;
pub extern fn luaL_ref(L: ?*lua_State, t: c_int) c_int;
pub extern fn luaL_unref(L: ?*lua_State, t: c_int, ref: c_int) void;
pub extern fn luaL_loadfile(L: ?*lua_State, filename: [*c]const u8) c_int;
pub extern fn luaL_loadbuffer(L: ?*lua_State, buff: [*c]const u8, sz: usize, name: [*c]const u8) c_int;
...
pub extern fn luaL_findtable(L: ?*lua_State, idx: c_int, fname: [*c]const u8, szhint: c_int) [*c]const u8;
...
pub extern fn luaL_pushmodule(L: ?*lua_State, modname: [*c]const u8, sizehint: c_int) void;
...
pub const luaconf_h = "";
pub const WINVER = @as(c_int, 0x0501);
...
pub const LUAL_BUFFERSIZE = if (BUFSIZ > @as(c_int, 16384)) @as(c_int, 8192) else BUFSIZ;
...
pub inline fn luaL_argcheck(L: anytype, cond: anytype, numarg: anytype, extramsg: anytype) anyopaque {
    _ = &L;
    _ = &cond;
    _ = &numarg;
    _ = &extramsg;
    return @import("std").zig.c_translation.cast(anyopaque, (cond != 0) or (luaL_argerror(L, numarg, extramsg) != 0));
}
...
pub inline fn luaL_checkint(L: anytype, n: anytype) c_int {
    _ = &L;
    _ = &n;
    return @import("std").zig.c_translation.cast(c_int, luaL_checkinteger(L, n));
}
pub inline fn luaL_optint(L: anytype, n: anytype, d: anytype) c_int {
    _ = &L;
    _ = &n;
    _ = &d;
    return @import("std").zig.c_translation.cast(c_int, luaL_optinteger(L, n, d));
}
pub inline fn luaL_checklong(L: anytype, n: anytype) c_long {
    _ = &L;
    _ = &n;
    return @import("std").zig.c_translation.cast(c_long, luaL_checkinteger(L, n));
}
pub inline fn luaL_optlong(L: anytype, n: anytype, d: anytype) c_long {
    _ = &L;
    _ = &n;
    _ = &d;
    return @import("std").zig.c_translation.cast(c_long, luaL_optinteger(L, n, d));
}
...
pub inline fn luaL_newlibtable(L: anytype, l: anytype) @TypeOf(lua_createtable(L, 0, @sizeOf(l) / @sizeOf((l)[0]) - 1)) {
...
// lauxlib.h:135:9
pub inline fn luaL_putchar(B: anytype, c: anytype) @TypeOf(luaL_addchar(B, c)) {
    _ = &B;
    _ = &c;
    return luaL_addchar(B, c);
}
