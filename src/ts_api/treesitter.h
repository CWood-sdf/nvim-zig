...
typedef uint32_t (*DecodeFunction)(const uint8_t *string, uint32_t length,
                                   int32_t *code_point);
 ...
 *    the same arguments.
 * 4. Parsing was cancelled due to the progress callback returning true. This
 callback
...
/**
 * @deprecated use [`ts_parser_parse_with_options`] and pass in a callback
 * instead, this will be removed in 0.26.
 *
...
/**
 * @deprecated use [`ts_query_cursor_exec_with_options`] and pass in a callback
 * instead, this will be removed in 0.26.
 *
 * Set the maximum duration in microseconds that query execution should be
 * allowed to take before halting.
 *
 * If query execution takes longer than this, it will halt early, returning
 * NULL. See [`ts_query_cursor_next_match`] or [`ts_query_cursor_next_capture`]
 * for more information.
 */
void ts_query_cursor_set_timeout_micros(TSQueryCursor *self,
...
/**
 * @deprecated use [`ts_language_abi_version`] instead, this will be removed in
 * 0.26.
 *
